...
const ToyotaFortunerDetails = () => {
  const car = {
    name: "Toyota Fortuner 2024",
    price: "PKR 14.5 1.99 crore ",
    imageUrl: "/Toyota Fortuner.jpeg",
    description: "Toyota Fortuner 2024 offers a blend of reliability and performance...",
    details: {
      doors: 4,
      engine: "2755 CC",
      condition: "8.5 / 10",
...
export default ToyotaFortunerDetails;

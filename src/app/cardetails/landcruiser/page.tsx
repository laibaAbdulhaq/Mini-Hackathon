...
const LandCruiserDetails = () => {
  const car = {
    name: "Land Cruiser 2024",
    price: "PKR 1.20 crore",
    imageUrl: "/land cruiser.jpeg",
    description: "Land Cruiser 2024 offers a blend of reliability and performance...",
    details: {
      doors: 4,
      engine: "3346 CC",
      condition: "9.5 / 10",
...
export default LandCruiserDetails;
